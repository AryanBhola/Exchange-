...
export const subscribeToEvents = (exchange, dispatch) => {
  ...
  exchange.on('Order', (id, user, tokenGet , amountGet, tokenGive, amoutnGive, timestamp, event) => {
    const order = event.args
    dispatch({ type: 'NEW_ORDER_SUCCESS', order,event })
  })
  exchange.on('Cancel', (id, user, tokenGet , amountGet, tokenGive, amoutnGive, timestamp, event) => {
    const order = event.args
